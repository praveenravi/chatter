...
if($_SERVER['HTTP_REFERER'] != "http://chatter.praveenravi.com/") {
    header("Location: http://praveenravi.com/");
    die();
}
...
<html>
    ...
    <body>
        ...
        <div id="remotes"></div>
         ...
         <!-- <div id="localScreenContainer" class="videoContainer">sdfd</div> -->

          <button id="screenShareButton">Button with no use</button>
    </body>
</html>